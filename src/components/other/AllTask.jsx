...
const AllTask = () => {
    return (
        <div className='bg-[#1c1c1c] p-5 text-white mt-5 h-100 overflow-auto'>
            <div className='bg-red-400 mb-2 py-2 px-4 flex justify-between rounded'>
                <h2>Sharthak</h2>
                <h3>Make a UI bruh</h3>
                <h5>Status</h5>
            </div>
            ...
            <div className='bg-amber-400-400 mb-2 py-2 px-4 flex justify-between rounded'>
                <h2>Sharthak</h2>
                <h3>Make a UI bruh</h3>
                <h5>Status</h5>
            </div>
